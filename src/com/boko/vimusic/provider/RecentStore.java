...
public class RecentStore extends SQLiteOpenHelper {
	...
	public void onCreate(final SQLiteDatabase db) {
		db.execSQL("CREATE TABLE IF NOT EXISTS " + RecentTable.TABLE_NAME
				...
				+ RecentTable.TIME_PLAYED + " LONG NOT NULL);"); // Album Time
																	// played
	}
	 ...
	 */
	public static final synchronized RecentStore getInstance(
	...
	public void addAlbum(final String albumId, final String albumHost,
		...
		if (albumId == null || albumHost == null || albumName == null
				|| artistName == null || songCount == null) {
			return;
		}
	...
	public String getMostPlayedAlbumName(final String artistName) {
		...
		final SQLiteDatabase database = getReadableDatabase();
		final String[] projection = new String[] { RecentTable.NAME };
		final String selection = RecentTable.ARTIST + "=?";
		final String[] having = new String[] { artistName };
		Cursor cursor = database.query(RecentTable.TABLE_NAME, projection,
				selection, having, null, null, RecentTable.TIME_PLAYED
						+ " DESC", null);
