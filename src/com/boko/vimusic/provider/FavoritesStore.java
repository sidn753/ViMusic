...
public class FavoritesStore extends SQLiteOpenHelper {
	 ...
	 */
	public static final synchronized FavoritesStore getInstance(
	...
	public void addSong(final String songId, final HostType songHost,
		...
		if (songId == null || songHost == null || songName == null
				|| albumName == null || artistName == null) {
			return;
		}
		...
		values.put(FavoritesTable.PLAY_COUNT, playCount != 0 ? playCount + 1
				: 1);
