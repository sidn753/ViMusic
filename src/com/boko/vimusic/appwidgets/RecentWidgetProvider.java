...
public class RecentWidgetProvider extends AppWidgetBase {
	...
	public void onUpdate(final Context context,
		...
		for (final int appWidgetId : appWidgetIds) {
			...
			final Intent updateIntent = new Intent(
					MusicPlaybackService.SERVICECMD);
			...
			mViews.setPendingIntentTemplate(R.id.app_widget_recents_list,
		...
		if (CLICK_ACTION.equals(action)) {
			...
			if (intent.getStringExtra(SET_ACTION).equals(PLAY_ALBUM)) {
				...
				if (albumId != null) {
					...
					shortcutIntent.putExtra(Config.MIME_TYPE,
							MediaStore.Audio.Albums.CONTENT_TYPE);
					shortcutIntent.putExtra(ShortcutActivity.OPEN_AUDIO_PLAYER,
							false);
				...
				bundle.putString(Config.MIME_TYPE,
						MediaStore.Audio.Albums.CONTENT_TYPE);
				bundle.putString(Config.NAME, albumName);
				bundle.putString(Config.ARTIST_NAME,
						intent.getStringExtra(Config.ARTIST_NAME));
				...
				final Intent profileIntent = new Intent(context,
					...
					sWorkerQueue.post(new Runnable() {
						...
						public void run() {
							...
							final ComponentName componentName = new ComponentName(
									service, RecentWidgetProvider.class);
	...
	private void linkButtons(final Context context, final RemoteViews views,
		...
		if (playerActive) {
			...
			views.setOnClickPendingIntent(R.id.app_widget_recents_action_bar,
					pendingIntent);
		} else {
			// Home
