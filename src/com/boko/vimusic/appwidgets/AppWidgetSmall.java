...
public class AppWidgetSmall extends AppWidgetBase {
	...
	private void defaultAppWidget(final Context context,
		...
		appWidgetViews.setViewVisibility(R.id.app_widget_small_info_container,
				View.INVISIBLE);
	...
	public void performUpdate(final MediaPlaybackService service,
		...
		if (TextUtils.isEmpty(trackName) && TextUtils.isEmpty(artistName)) {
			appWidgetView.setViewVisibility(
					R.id.app_widget_small_info_container, View.INVISIBLE);
		} else {
			appWidgetView.setViewVisibility(
					R.id.app_widget_small_info_container, View.VISIBLE);
