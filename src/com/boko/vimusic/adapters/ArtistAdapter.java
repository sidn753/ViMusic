...
public class ArtistAdapter extends ArrayAdapter<Artist> {
	...
	public View getView(final int position, View convertView,
		...
		if (mLoadExtraData) {
			...
			mImageFetcher.loadArtistImage(dataHolder.mLineOne,
	 ...
	 * 
	 * @param artist
	 *            The {@link ImageView} holding the aritst image
	 * @param position
	...
	private void playArtist(final ImageView artist, final int position) {
		artist.setOnClickListener(new OnClickListener() {
			...
			public void onClick(final View v) {
				...
				final Song[] list = MusicUtils.getSongListForArtist(
						getContext(), id);
	...
	/**
	 * @param artist
	 *            The key used to find the cached artist to remove
	 */
