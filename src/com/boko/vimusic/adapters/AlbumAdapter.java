...
public class AlbumAdapter extends ArrayAdapter<Album> {
	...
	public View getView(final int position, View convertView,
		...
		mImageFetcher.loadAlbumImage(dataHolder.mLineTwo, dataHolder.mLineOne,
		...
		if (mLoadExtraData) {
			...
			mImageFetcher.loadArtistImage(dataHolder.mLineTwo,
	 ...
	 * 
	 * @param album
	 *            The {@link ImageView} holding the album
	 * @param position
	 *            The position of the album to play.
	 */
	private void playAlbum(final ImageView album, final int position) {
		album.setOnClickListener(new OnClickListener() {
			...
			public void onClick(final View v) {
				...
				final Song[] list = MusicUtils.getSongListForAlbum(
						getContext(), id);
	...
	/**
	 * @param album
	 *            The key used to find the cached album to remove
	 */
	public void removeFromCache(final Album album) {
		if (mImageFetcher != null) {
			mImageFetcher.removeFromCache(ImageFetcher.generateAlbumCacheKey(
					album.getName(), album.mArtistName));
		}
	}
	...
	/**
	 * @param extra
	 *            True to load line three and the background image, false
	 *            otherwise.
	 */
	...
	/**
	 * @param play
	 *            True to play the album when the artwork is touched, false
	 *            otherwise.
	 */
