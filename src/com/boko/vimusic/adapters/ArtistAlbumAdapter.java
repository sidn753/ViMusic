...
public class ArtistAlbumAdapter extends ArrayAdapter<Album> {
	...
	public View getView(final int position, View convertView,
		...
		holder.mLineTwo.get().setText(
				MusicUtils.makeLabel(getContext(), R.plurals.Nsongs,
						album.mSongNumber));
		// Set the album year (line three)
		holder.mLineThree.get().setText(album.mYear);
		// Asynchronously load the album images into the adapter
		mImageFetcher.loadAlbumImage(album.mArtistName, albumName,
				album.getId(), holder.mImage.get());
	...
	/**
	 * @param data
	 *            The {@link List} used to return the count for the adapter.
	 */
