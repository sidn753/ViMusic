...
package com.boko.vimusic.format;
...
public class PrefixHighlighter {
	 ...
	 * 
	 * @param view
	 *            The {@link TextView} on which to set the text
	 * @param text
	...
	public void setText(final TextView view, final String text,
			final char[] prefix) {
		if (view == null || TextUtils.isEmpty(text) || prefix == null
				|| prefix.length == 0) {
			return;
		}
