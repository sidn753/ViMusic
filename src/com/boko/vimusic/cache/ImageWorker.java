...
public abstract class ImageWorker {
	...
	private final class BitmapWorkerTask extends
		 ...
		 * @param imageType
		 *            The type of image URL to fetch for.
		 */
		...
		protected TransitionDrawable doInBackground(final String... params) {
			...
			if (bitmap == null && mImageType.equals(ImageType.ALBUM)
					&& mAlbumId != null && mKey != null && !isCancelled()
	 ...
	 * @param artistName
	 *            The artist name for the Last.fm API.
	 * @param albumName
	 *            The album name for the Last.fm API.
	 * @param albumId
	 *            The album art index, to check for missing artwork.
	 * @param imageView
	 *            The {@link ImageView} used to set the cached {@link Bitmap}.
	 * @param imageType
	 *            The type of image URL to fetch for.
	 */
	protected void loadImage(final String key, final String artistName,
			final String albumName, final String albumId,
	 ...
	 * 
	 * @param artistName
	 *            The artist name param used in the Last.fm API.
	 * @param albumName
	 *            The album name param used in the Last.fm API.
	 * @param imageType
	 *            The type of image URL to fetch for.
