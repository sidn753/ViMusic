...
public class MusicHolder {
	...
	public MusicHolder(final View view) {
		...
		// Initialize mLineOne
		mLineOne = new WeakReference<TextView>(
				(TextView) view.findViewById(R.id.line_one));

		// Initialize mLineTwo
		mLineTwo = new WeakReference<TextView>(
				(TextView) view.findViewById(R.id.line_two));

		// Initialize mLineThree
		mLineThree = new WeakReference<TextView>(
				(TextView) view.findViewById(R.id.line_three));
	}
