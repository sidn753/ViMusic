...
import static com.boko.vimusic.utils.PreferenceUtils.ARTIST_LAYOUT;
...
import com.boko.vimusic.adapters.ArtistAdapter;
import com.boko.vimusic.loaders.ArtistLoader;
...
public class ArtistFragment extends Fragment implements
		LoaderCallbacks<List<Artist>>, OnScrollListener, OnItemClickListener,
		MusicStateListener {
	...
	public void onCreateContextMenu(final ContextMenu menu, final View v,
		...
		mArtistList = MusicUtils.getSongListForArtist(getActivity(),
				mArtist.getId());
	...
	public boolean onContextItemSelected(final android.view.MenuItem item) {
		...
		if (item.getGroupId() == GROUP_ID) {
			...
			case FragmentMenuItems.NEW_PLAYLIST:
				CreateNewPlaylist.getInstance(mArtistList).show(
	 ...
	 */
	@Override
	public void onLoadFinished(final Loader<List<Artist>> loader,
