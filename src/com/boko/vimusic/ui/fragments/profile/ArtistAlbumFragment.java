...
import com.boko.vimusic.adapters.ArtistAlbumAdapter;
import com.boko.vimusic.loaders.ArtistAlbumLoader;
 ...
 */
public class ArtistAlbumFragment extends Fragment implements
	...
	public View onCreateView(final LayoutInflater inflater,
		...
		mListView.setOnScrollListener(new VerticalScrollListener(
				mScrollableHeader, mProfileTabCarousel, 1));
	...
	public boolean onContextItemSelected(final MenuItem item) {
		...
		if (item.getGroupId() == GROUP_ID) {
			...
			case FragmentMenuItems.DELETE:
				DeleteDialog.newInstance(mAlbum.getName(), mAlbumList, null)
